...
class InflammationDiseaseComparison(BaseModel):
    ...
    signature_type: str
    disease: str
    activity_diff: float = Field(description="Activity difference (disease - healthy). Activity difference (z-score).")
    mean_disease: float
    mean_healthy: float
...
class InflammationDiseaseGroupComparison(BaseModel):
    ...
    signature_type: str
    disease_group: str
    activity_diff: float = Field(description="Activity difference. Activity difference (z-score).")
    p_value: float
...
class InflammationCellTypeStratified(BaseModel):
    ...
    signature_type: str
    disease: str
    activity_diff: float = Field(description="Activity difference (disease - healthy). Activity difference.")
    p_value: float
    q_value: float | None = None
...
class InflammationDrivingPopulation(BaseModel):
    ...
    mean_activity_diff: float = Field(description="Mean activity difference across signatures.")
...
class InflammationConservedProgram(BaseModel):
    ...
    diseases: list[str]
    n_diseases: int
    mean_activity_diff: float = Field(description="Mean activity difference across diseases.")
