...
#SBATCH --output=/vf/users/parks34/projects/2cytoatlas/logs/all_gene_expr_%j.out
#SBATCH --error=/vf/users/parks34/projects/2cytoatlas/logs/all_gene_expr_%j.err
