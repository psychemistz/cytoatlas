...
#SBATCH --output=/vf/users/parks34/projects/2cytoatlas/logs/cima_expr_boxplot_%j.out
#SBATCH --error=/vf/users/parks34/projects/2cytoatlas/logs/cima_expr_boxplot_%j.err
#SBATCH --time=2:00:00
#SBATCH --mem=128G
