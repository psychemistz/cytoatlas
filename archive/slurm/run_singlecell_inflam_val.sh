...
#SBATCH --output=/data/parks34/projects/2cytoatlas/logs/inflam_val_singlecell_%j.out
#SBATCH --error=/data/parks34/projects/2cytoatlas/logs/inflam_val_singlecell_%j.err
