...
#SBATCH --output=/vf/users/parks34/projects/2secactpy/logs/sc_activity_json_%j.out
#SBATCH --error=/vf/users/parks34/projects/2secactpy/logs/sc_activity_json_%j.err
