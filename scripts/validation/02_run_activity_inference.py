...
PSEUDOBULK_ROOT = Path('/vf/users/parks34/projects/2secactpy/results/validation/pseudobulk')
OUTPUT_ROOT = Path('/vf/users/parks34/projects/2secactpy/results/validation/activity')
